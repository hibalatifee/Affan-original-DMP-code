...
% addpath('C:\Users\TeleOperation\Downloads\TeleoperationData\Experiment1/Subject1'); %addition/change in original code by Hiba
...
addpath(genpath('C:\Users\TeleOperation\Downloads\matlab-zmq-master')) %addition/change in original code by Hiba
...
% load('experiment1_subject3_trial1.mat'); %addition/change in original code by Hiba
...
load('demo2.mat'); %addition/change in original code by Hiba
load('demo3.mat'); 
load('demo4.mat'); 
load('demo5.mat'); 


% figure; %addition/change in original code by Hiba
% hold on;
...
%addition/change in original code by Hiba 
...
yy = spline(linspace(0,1,length(Demo2)),Demo2,linspace(0,1,1300)); %sampled to get 1300 data points for an input time duration of 0 to 1
yy1=yy'; % for formatting
yy1_v = (yy1(1:end-1,:)-yy1(2:end,:))/(time_duration/1300); % numerical differentation to get velocity and acceleration, time duration in between two datapoints 
yy1_a = (yy1_v(1:end-1,:)-yy1_v(2:end,:))/(time_duration/1300);

yy = spline(linspace(0,1,length(Demo3)),Demo3,linspace(0,1,1300));
yy2=yy';
yy2_v = (yy2(1:end-1,:)-yy2(2:end,:))/(time_duration/1300);
yy2_a = (yy2_v(1:end-1,:)-yy2_v(2:end,:))/(time_duration/1300);


yy = spline(linspace(0,1,length(Demo4)),Demo4,linspace(0,1,1300));
yy4=yy';
% yy4=yy4(1:7000,:);
yy4_v = (yy4(1:end-1,:)-yy4(2:end,:))/(time_duration/1300);
yy4_a = (yy4_v(1:end-1,:)-yy4_v(2:end,:))/(time_duration/1300);
...
yy = spline(linspace(0,1,length(Demo5)),Demo5,linspace(0,1,1300));
yy5=yy';
% yy5=yy5(4000:end,:);
yy5_v = (yy5(1:end-1,:)-yy5(2:end,:))/(time_duration/1300);
yy5_a = (yy5_v(1:end-1,:)-yy5_v(2:end,:))/(time_duration/1300);
...
% figure %addition/change in original code by Hiba 
plot3(Demo2(1,:),Demo2(2,:),Demo2(3,:));
plot3(Demo3(1,:),Demo3(2,:),Demo3(3,:));
plot3(Demo4(1,:),Demo4(2,:),Demo4(3,:));
plot3(Demo5(1,:),Demo5(2,:),Demo5(3,:));
